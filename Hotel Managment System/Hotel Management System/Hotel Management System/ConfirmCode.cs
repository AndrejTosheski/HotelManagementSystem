...
namespace Hotel_Management_System
{
    public partial class ConfirmCode : Form
    {
        ...
        private void buttonConfirmCode_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Activation code is incorrect!", "HMS", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                try
                {
                    ...
                    con.Close();
                    MessageBox.Show("Registered successfully!", "HMS", MessageBoxButtons.OK, MessageBoxIcon.None);
                    this.Close();
                }
                catch
                {
