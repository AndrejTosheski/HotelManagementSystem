...
namespace Hotel_Management_System
{
    public partial class Register : Form
    {
        ...
        public static void InsertIntoTable(Licnost licnost)
        {
            try
            {
                ...
                {             
                    ...
                    MessageBox.Show("Username already exists! You can use " + temp + " instead.", "HMS", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    dataReader.Close();
                    con.Close();
                }
            }
            ...
            {
                MessageBox.Show("Please enter a valid email!", "HMS", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }                     
        }
        ...
        public static void SendMsg(string email, string fullname, string username, string pass, string random)
        {
            ...
            {
                smtp.Send(msg);
                MessageBox.Show("Email sent, please enter confirmation code.", "HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);          
            }
            catch
            {
                throw;
